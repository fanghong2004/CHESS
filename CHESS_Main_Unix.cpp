...
{
	//The following is for Unix version
	struct In_File_Path  Path = {};
	struct Input_Data_Range InRange = {};
	struct Out_Data_Range  OutRange = {};
	struct Spin_Up   Spin = {};
	...
	//===========================================================================================================================
	//reading CHESS_info.TXT file for spatial scope, and simulation years
	read_CHESS_File("CHESS_info.txt", &Grid, &Path, &InRange, &OutRange, &Spin);
