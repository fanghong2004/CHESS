...
int       maxc = 165, maxr = 190;
double    xll = 776948.172550;
double    yll = 2618333.180600;
double    cellsize = 200;
float     NODATA_value = -9999.0;

const int num_patches = { 11836 };

// define the simulation year, month and day
const int start_year = 1975, end_year = 2013, start_month = 1, end_month = 12, start_day = 1, end_day = 31;
...
struct out_date_range out_date = { 1976, 1988, 1, 12, 1, 31, 1, 24 };
...
const int spin_years = 30, spin_interval = 30;
bool      spin_flag = true;

// define the input file prefix and paths for model forcing data
char  prefix[20] = "lxh_200";

char  inDefFile[120] = { "D://muzhen//guihui//200//defs//" };
char  inImgFile[120] = { "D://muzhen//guihui//200//flowtable//" };
char  inFlowFile[120] = { "D://muzhen//guihui//200//flowtable//" };
char  inClimPath[120] = { "D://muzhen//guihui//200//climate//" };
char  outPutPath[120] = { "D://muzhen//guihui//200//output//" };

char  FlowTableName[40] = "lxh_200_flow_table.dat";
