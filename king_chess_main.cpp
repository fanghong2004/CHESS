...
int       maxc = 112, maxr = 140;
double    xll = 481799.551;
double    yll = 4338291.155;
double    cellsize = 100;
float     NODATA_value = -9999;

// define the simulation year, month and day
const int start_year = 1981, end_year = 2012, start_month = 1, end_month = 12, start_day = 1, end_day = 31;
...
struct out_date_range out_date = {1991, 2012, 1, 12, 1, 31, 1, 24 };
...
const int spin_years =10, spin_interval = 10;
bool      spin_flag = true;

// define the input file prefix and paths for model forcing data
char  prefix[20] = "king";
char  inDefFile[120] = { "D://GIS//newgb//kingston//defs//" };
char  inImgFile[120] = { "D://GIS//newgb//kingston//inputimage//" };
char  inFlowFile[120] = { "D://GIS//newgb//kingston//inputimage//" };
char  inClimPath[120] = { "D://GIS//newgb//snotel//" };
char  outPutPath[120] = { "D://GIS//newgb//kingston//simulated//" };

char  FlowTableName[40] = "king_flow_table.dat";
