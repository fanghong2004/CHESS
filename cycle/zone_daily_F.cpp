						...
						struct 	date 	current_date)
{
	...
	if ((patch->daylength_flag == 0) && (patch->e_horizon == 0) && (patch->w_horizon == 0)){
		...
		if ((patch->Kdown_direct_flag == 0) || (patch->Kdown_diffuse_flag == 0)){
			patch->Kdown_direct  = patch->Kdown_direct	* (patch->daylength / patch->metv.dayl);
	...
	if ((patch->Kdown_direct_flag == 0) || (patch->Kdown_diffuse_flag == 0)){
		...
		//=======================================================================================================================
		patch->radrat = (patch->Kdown_direct + patch->Kdown_diffuse) / (patch->Kdown_direct_flat + patch->Kdown_diffuse_flat);
	}
	...
	patch->daily_clim->daytime_rain_duration = -999.;
