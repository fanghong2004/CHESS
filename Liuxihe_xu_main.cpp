...
//LXH_TEST
int       maxr = 58, maxc = 54;
double    xll = 473217.11317;
double    yll = 2617620.82785;
double    cellsize = 600;
float     NODATA_value = -9999;

// define the simulation year, month and day
const int start_year = 1975, end_year = 1980, start_month = 1, end_month = 12, start_day = 1, end_day = 31;
...
struct out_date_range out_date = { 1976, 1979, 1, 12, 1, 31, 1, 24 };
...
const int spin_years = 14, spin_interval = 2;
bool      spin_flag = true;

// define the input file prefix and paths for model forcing data
char  prefix[20] = "lxh";
char  inDefFile[120] = { "D://muzhen//xuzhengwudata//lxh_test//defs//" };
char  inImgFile[120] = { "D://muzhen//xuzhengwudata//lxh_test//flowtable//" };
char  inFlowFile[120] = { "D://muzhen//xuzhengwudata//lxh_test//flowtable//" };
char  inClimPath[120] = { "D://muzhen//xuzhengwudata//lxh_test//climate//" };
char  outPutPath[120] = { "D://muzhen//xuzhengwudata//lxh_test//out//" };

char  FlowTableName[40] = "lxh_flow_table_MD8.dat";



//lc
/*
int       maxr = 415, maxc = 400;
double    xll = 874268.138;
double    yll = 2671805.4649658;
double    cellsize = 300;
float     NODATA_value = -9999;
...
// define the number of spin years required for vegetation and soil carbon to reach the stable state with long-term
// climatology. Spin interval is the period of input climate data used for spin-up simulations
const int spin_years = 10, spin_interval = 2;
bool      spin_flag = true;

// define the input file prefix and paths for model forcing data
char  prefix[20] = "lc";
char  inDefFile[120] = { "I://xu//CHESS//IN//lc//defs//" };
char  inImgFile[120] = { "I://xu//CHESS//IN//lc//flowtable//" };
char  inFlowFile[120] = { "I://xu//CHESS//IN//lc//flowtable//" };
char  inClimPath[120] = { "I://xu//CHESS//IN//lc//climate//" };
char  outPutPath[120] = { "I://xu//CHESS//OUT//lc//" };

char  FlowTableName[40] = "lc_flow_table_MD8.dat";
*/
		...
		for (current_date.year = start_year; current_date.year <= endyear; current_date.year++){
			...
			for (current_date.month = firstmonth; current_date.month <= lastmonth; current_date.month++){
				...
				for (current_date.day = firstday; current_date.day <= lastday; current_date.day++){
					...
					//add one more parameters cellsize
