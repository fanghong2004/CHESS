...
int	main(int main_argc, char **main_argv)
{
	...
	struct Input_Data_Range InRange = { 1975, 2013, 1, 12, 1, 31, 1, 24 };
	...
	struct Out_Data_Range OutRange = { 1976, 1988, 1, 12, 1, 31, 1, 24 };
	...
	struct Spin_Up   Spin = { 30, 30, true };

	//4. define the input file prefix and paths for model forcing data
	struct In_File_Path Path{
		"lxh_90",   //input file name prefix
		"D://muzhen//guhui//90//defs//", //input_default_file_directory
		"D://muzhen//guhui//90//flowtable//", //input_image_file_directory
		"D://muzhen//guhui//90//climate//", //input_climate_file_directory
		"D://muzhen//guhui//90//output//",    //output_file_directory
		"lxh_90_flow_table.dat" //flow table name
	};
