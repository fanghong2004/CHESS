...
int       maxr = 153, maxc = 149;
double    xll = 627293.48845;
double    yll = 4492445.09563;
double    cellsize = 90;
float     NODATA_value = -9999;

const int num_patches = 7997;
// define the simulation year, month and day
const int start_year = 1981, end_year = 2017, start_month = 1, end_month = 12, start_day = 1, end_day = 31;
...
struct out_date_range out_date = { 1990, 2017, 1, 12, 1, 31, 1, 24 };
...
char  prefix[20] = "lam";
char  inDefFile[120] = { "D://GIS//newgb//lamoille//defs//" };
char  inImgFile[120] = { "D://GIS//newgb//lamoille//inputimage//" };
char  inFlowFile[120] = { "D://GIS//newgb//lamoille//inputimage//" };
char  inClimPath[120] = { "D://GIS//newgb//snotel//" };
char  outPutPath[120] = { "D://GIS//newgb//lamoille//simulated1//" };

char  FlowTableName[40] = "lam_flow_table.dat";
