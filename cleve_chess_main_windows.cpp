...
int	main(int main_argc, char **main_argv)
{
	...
	struct Input_Data_Range InRange = { 1961, 2012, 1, 12, 1, 31, 1, 24 };
	...
	struct Out_Data_Range OutRange  = { 1990, 2015, 1, 12, 1, 31, 1, 24 };
	...
	struct Spin_Up   Spin = { 4, 30, true };

	//4. define the input file prefix and paths for model forcing data
	struct In_File_Path Path{
		"cleve",   //input file name prefix
		"D://newgb//clevenew//defs//", //input_default_file_directory
		"D://newgb//clevenew//flowtable//", //input_image_file_directory
		"D://newgb//clevenew//baseline//", //input_climate_file_directory
		"D://newgb//clevenew//out//",   //output_file_directory
		"cleve_flow_table_MD8.dat" //flow table name
	};
