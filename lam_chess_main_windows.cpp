...
int	main(int main_argc, char **main_argv)
{
	...
	struct Input_Data_Range InRange = {1981, 2017, 1, 12, 1, 31, 1, 24 };
	...
	struct In_File_Path Path{
		"lam",   //input file name prefix
		"D://GIS//newgb//lamoille//defs//", //input_default_file_directory
		"D://GIS//newgb//lamoille//inputimage//", //input_image_file_directory
		"D://GIS//newgb//snotel//", //input_climate_file_directory
		"D://GIS//newgb//lamoille//simulated3//",    //output_file_directory
		"lam_flow_table.dat" //flow table name
	};
