...
int       maxr = 143, maxc = 115;
double    xll = 701984.000000;
double    yll = 4342483.000000;
double    cellsize = 100.;
float     NODATA_value = -9999.0;

// define the simulation year, month and day
const int start_year = 1961, end_year = 2012, start_month = 1, end_month = 12, start_day = 1, end_day = 31;
...
const int spin_years =0, spin_interval = 30;
bool      spin_flag = true;

// define the input file prefix and paths for model forcing data
char  prefix[20] = "cleve";
//char  inDefFile[120] = { "D://muzhen//xuzhengwudata//defs//" };
//char  inImgFile[120] = { "D://muzhen//xuzhengwudata//inputimage//" };
//char  inFlowFile[120] = { "D://muzhen//xuzhengwudata//inputimage//" };
//char  inClimPath[120] = { "D://muzhen//xuzhengwudata//climate//1980//" };
//char  outPutPath[120] = { "D://muzhen//xuzhengwudata//outdata//" };

char  inDefFile[120] = { "D://clevenew//defs//" };
char  inImgFile[120] = { "D://clevenew//flowtable//" };
char  inFlowFile[120] = { "D://clevenew//flowtable//" };
char  inClimPath[120] = { "D://clevenew//BASELINE//" };
char  outPutPath[120] = { "D://clevenew//MD8//" };

char  FlowTableName[40] = "cleve_flow_table_MD8.dat";
			...
			for (current_date.month = firstmonth; current_date.month <= lastmonth; current_date.month++){
				...
				for (current_date.day = firstday; current_date.day <= lastday; current_date.day++){
					...
					for (i = 0; i<num_patches; i++){
						...
						//if (patch[i].ID == 7153 && current_date.month == 1 && current_date.day == 1)
						//	cout << patch[i].canopy_strata->phen.litfall_stopday << endl;
