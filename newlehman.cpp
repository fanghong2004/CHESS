...
/*
int        maxc = 106, maxr = 54;
double    xll = 731600;
double    yll = 4318100;
double    cellsize = 90;
float     NODATA_value = -9999;

const int num_patches = { 2917 };

// define the simulation year, month and day
const int start_year = 1961, end_year = 2015, start_month = 1, end_month = 6, start_day = 1, end_day = 22;
...
struct out_date_range out_date = {1961, 1997, 10, 9, 1, 30, 1, 24 };
//struct out_date_range out_date = { 2014, 2018, 5, 6, 29, 12, 1, 24 };
...
char  prefix[20] = "leeman";
char  inDefFile[120] = { "d://muzhen//xiaohua//defs//" };
char  inImgFile[120] = { "d://muzhen//xiaohua//" };
char  inFlowFile[120] = { "d://muzhen//xiaohua//" };
char  inClimPath[120] = { "d://muzhen//xiaohua//climate//" };
char  outPutPath[120] = { "d://muzhen//xiaohua//results//" };

char  FlowTableName[40] = "leeman_flow_table.dat";
*/


int        maxc = 124, maxr = 148;
double    xll = 731600;
double    yll = 4318100;
double    cellsize = 120;
float     NODATA_value = -9999;

const int num_patches = { 5781 };
...
// define the time period for outputting simulation results
// out_date_range outdate={first_year, last_year, first_month, last_month, first_day, last_day, first_hour, last_hour};
struct out_date_range out_date = { 1991, 2015, 1, 12, 1, 31, 1, 24 };
//struct out_date_range out_date = { 2014, 2018, 5, 6, 29, 12, 1, 24 };

// define the number of spin years required for vegetation and soil carbon to reach the stable state with long-term
// climatology. Spin interval is the period of input climate data used for spin-up simulations
const int spin_years = 0, spin_interval = 15;
bool      spin_flag = true;

// define the input file prefix and paths for model forcing data
char  prefix[20] = "cleve_120";
char  inDefFile[120] = { "D://xuzhenwu//120F//defs//" };
char  inImgFile[120] = { "D://xuzhenwu//120F//geo//" };
char  inFlowFile[120] = { "D://xuzhenwu//120F//flowtable//" };
char  inClimPath[120] = { "D://xuzhenwu//120F//clim//" };
char  outPutPath[120] = { "D://xuzhenwu//120F//out//" };

char  FlowTableName[40] = "cleve_120_flow_table_D8.dat";
...
//=======================================================================================================================
	int	main(int main_argc, char **main_argv)
	{
		...
		patch = (struct patch_object *) calloc(num_patches, sizeof(struct patch_object));

		//reading GRASS- or ArcInfo-based input images such as DEM,slope,aspect....stream,roads
		read_images(patch, maxr, maxc, cellsize, xll, yll, NODATA_value, inImgFile, prefix, f_flag, arc_flag);

		//Initialize the default values of patch fields/members
		construct_patch(patch, command_line, num_patches, inDefFile, prefix);

		//constructing routing list topography
		construct_routing_topology(patch, inFlowFile, FlowTableName, num_patches);
