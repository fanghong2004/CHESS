...
const int spin_years =4, spin_interval = 30;
bool      spin_flag = true;

// define the input file prefix and paths for model forcing data
char  prefix[20] = "cleve";

char  inDefFile[120] = { "e://clevenew//defs//" };
//char  inDefFile[120] = { "D:/muzhen/xuzhengwudata/defs/" };
char  inImgFile[120] = { "e://clevenew//flowtable//" };
char  inFlowFile[120] = { "e://clevenew//flowtable//" };
char  inClimPath[120] = { "e://clevenew//BASELINE//" };
//char  inClimPath[120] = { "e://clevenew//2005experiment2//" };
char  outPutPath[120] = { "e://clevenew//test//" };
