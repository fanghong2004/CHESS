...
int       maxr = 183, maxc = 466;
double    xll = 731600;
double    yll = 4318100;
double    cellsize = 28.16105;
float     NODATA_value = -9999;

// define the simulation year, month and day
const int start_year = 1961, end_year = 2011, start_month = 1, end_month = 12, start_day = 1, end_day = 31;
...
struct out_date_range out_date = {1992, 2015, 1, 12, 1, 31, 1, 24 };
...
char  prefix[20] = "lehman";
char  inDefFile[120] = { "D://GBNP//LehmanCreek//defs//" };
char  inImgFile[120] = { "D://GBNP//LehmanCreek//inputimage//" };
char  inFlowFile[120] = { "D://GBNP//LehmanCreek//inputimage//" };
char  inClimPath[120] = { "D://GBNP//LehmanCreek//climatedata//" };
char  outPutPath[120] = { "D://GBNP//LehmanCreek//outdata//" };

char  FlowTableName[40] = "lehman_flow_table.dat";
